...
class Death(Scene):
    ...
    quips = [
        ...
        "You died. Unglaubliche",
        "You died. Is that the best you can do?"
    ]
...
class Final(Scene):
    ...
    def enter(self, hero):
        ...
        monster = Monster("Wilson")

        print "%s, You hear a noise nearby... Oh no!" % (hero.name)
        print "It appears there was a Gothan named %s on board! Let's fight!!!" % (monster.name)
